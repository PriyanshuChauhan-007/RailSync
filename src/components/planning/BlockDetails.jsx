        ...
        <details className="block-technical-details">
          ...
          <div className="block-technical-body">
            <dl className="block-details-facts">
              ...
              <div><dt>Power isolation zone</dt><dd>{block.power_isolation_zone_id ?? "ES-04 (Ballabgarh TSS 25 kV AC) · Diesel bypass authorized"}</dd></div>
              <div><dt>Machine Siding Transit</dt><dd>Plasser Duomatic Tamper: 22 min transit from TKD siding (30 km/h) locked</dd></div>
              <div><dt>OHE Isolation Limits</dt><dd>Elementary Section ES-04 de-energized; Pantograph lowering notice issued</dd></div>
